...
import ${packageName}.utils.DensityUtil;
...
//        }
        ...
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_android_textColor, ContextCompat.getColor(getContext(), R.color.default_text_grey_color));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_android_textSize, DensityUtil.sp2px(getContext(),14));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.default_text_green_color));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, DensityUtil.sp2px(getContext(),14));
