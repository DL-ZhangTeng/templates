...
//    private float bottomShadowHeight;                   // 底部阴影高度
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        PADDING_10 = DensityUtil.dip2px(10, context);
        PADDING_16 = DensityUtil.dip2px(16, context);

        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CommonTitleBar);

        titleBarColor = array.getColor(R.styleable.CommonTitleBar_titleBarColor, getResources().getColor(R.color.titlebar_bg));
        titleBarHeight = (int) array.getDimension(R.styleable.CommonTitleBar_titleBarHeight, getResources().getDimensionPixelSize(R.dimen.titlebar_height));
...
//        bottomShadowHeight = array.getDimension(R.styleable.CommonTitleBar_bottomShadowHeight, DensityUtil.dip2px(0,context));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextColor = array.getColor(R.styleable.CommonTitleBar_leftTextColor, getResources().getColor(R.color.titlebar_text_color));
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize, DensityUtil.dip2px(14, context));
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextColor = array.getColor(R.styleable.CommonTitleBar_rightTextColor, getResources().getColor(R.color.titlebar_text_color));
            rightTextSize = array.getDimension(R.styleable.CommonTitleBar_rightTextSize, getResources().getDimensionPixelSize(R.dimen.titlebar_text_size));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextColor = array.getColor(R.styleable.CommonTitleBar_centerTextColor, getResources().getColor(R.color.titlebar_text_color));
            centerTextSize = array.getDimension(R.styleable.CommonTitleBar_centerTextSize, getResources().getDimensionPixelSize(R.dimen.titlebar_title_size));
            ...
            centerSubTextSize = array.getDimension(R.styleable.CommonTitleBar_centerSubTextSize, DensityUtil.dip2px(11, context));
...
//        }
    ...
    private void initMainLeftViews(Context context) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            tvLeft.setPadding(PADDING_16, 0, PADDING_16, 0);
    ...
    private void initMainRightViews(Context context) {
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            tvRight.setPadding(PADDING_16, 0, PADDING_16, 0);
...
//            centerParams.rightMargin = PADDING_12;
            ...
            // 设置跑马灯效果
            tvCenter.setMaxWidth((int) (DensityUtil.getScreenWidth(context) * 3 / 5.0));
            ...
            // 设置边距
            centerParams.topMargin = DensityUtil.dip2px(7, context);
            centerParams.bottomMargin = DensityUtil.dip2px(7, context);
...
//                centerParams.rightMargin = PADDING_12;
            ...
            int searchIconWidth = DensityUtil.dip2px(15, context);
...
//            voiceParams.rightMargin = PADDING_12;
            ...
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX, DensityUtil.dip2px(14, context));
...
//    }
    ...
    public void showLeftBack(Context context) {
        if (rlMain.indexOfChild(btnLeft) >= 0) {
            return;
        }
        LayoutParams leftInnerParams = new LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        leftInnerParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
        ...
        btnLeft = new ImageButton(context);
        btnLeft.setBackgroundColor(Color.TRANSPARENT);
        btnLeft.setImageResource(R.drawable.comm_titlebar_left_back);
        btnLeft.setPadding(PADDING_10, 0, PADDING_10, 0);
        btnLeft.setOnClickListener(this);
