...
<recipe>
    ...
    <instantiate from="root/src/app_package/mvp/base/BaseLoadingPresenter.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/mvp/base/BaseLoadingPresenter.java" />
    <instantiate from="root/src/app_package/mvp/base/PresenterProxy.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/mvp/base/PresenterProxy.java" />
	</#if>
    <instantiate from="root/src/app_package/mvp/model/MainModel.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/mvp/model/${model}.java" />
    <instantiate from="root/src/app_package/mvp/presenter/ipresenter/IMainPresenter.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/mvp/presenter/ipresenter/${ipresenter}.java" />
