...
import ${packageName}.widget.MyHorizontalScrollView;
import ${packageName}.widget.ObservableScrollView;
import ${packageName}.widget.WrapContentListView;
    ...
    public class LeftAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (position) {
                //上午
                case 0:
                    holder.tv_fundname.setBackgroundColor(${className}.this.getResources().getColor(R.color.forenoon_color));
                ...
                //下午
                case 5:
                    holder.tv_fundname.setBackgroundColor(${className}.this.getResources().getColor(R.color.afternoon_color));
                    holder.tv_num.setText("1");
                    break;
                case 6:
                    holder.tv_fundname.setBackgroundColor(${className}.this.getResources().getColor(R.color.afternoon_color));
                ...
                //晚上
                case 10:
                    holder.tv_fundname.setBackgroundColor(${className}.this.getResources().getColor(R.color.night_color));
                    holder.tv_num.setText("1");
                    break;
                case 11:
                    holder.tv_fundname.setBackgroundColor(${className}.this.getResources().getColor(R.color.night_color));
