...
<resources>
    ...
    <declare-styleable name="PagerSlidingTabStrip">
        ...
        <attr name="pstsTabSelectedBackground" format="reference"/>
        <attr name="pstsTabUnSelectedBackground" format="reference"/>
	...
	<declare-styleable name="ViewPagerIndicator">
        ...
        <attr name="vpiCustomSubItemTabPageIndicatorStyle" format="reference"/>
        <!-- Style of the custom tab indicator's tabs. -->
        <attr name="vpiIconTabPageIndicatorStyle"  format="reference"/>
        <!-- Style of the underline indicator. -->
        <attr name="vpiUnderlinePageIndicatorStyle" format="reference"/>
        <!--Style of the CenterTab indicator.  -->
        <attr name="vpiCenterTabPageIndicatorStyle" format="reference"></attr>
    </declare-styleable>
