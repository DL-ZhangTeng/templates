...
<globals>
	...
	<#assign baseActivity=appCompat && (buildApi gte 22)>
	...
	<global id="baseActivity" type ="boolean" value="${baseActivity?string}"/>
    <global id="hasAppBar" type="boolean" value="${baseActivity?string}" />
    <global id="hasNoActionBar" type="boolean" value="${baseActivity?string}" />
...
<#elseif baseActivity>
    ...
    <global id="superClassFqcn" type="string" value="${applicationPackage}.base.BaseActivity"/>
