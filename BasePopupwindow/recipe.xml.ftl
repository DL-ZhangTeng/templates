...
<recipe>
	...
	<merge from="root/res/anim/self_popupwindow_showasdropup_close.xml" to="${escapeXmlAttribute(resOut)}/anim/self_popupwindow_showasdropup_close.xml" />
	<merge from="root/res/anim/self_popupwindow_showasdropup_open.xml" to="${escapeXmlAttribute(resOut)}/anim/self_popupwindow_showasdropup_open.xml" />
